...
export const DATA = {
  ...
  contact: {
    ...
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/joshelvn11",
        icon: Icons.github,
      ...
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/josh-beaver-6a2129282/",
        icon: Icons.linkedin,
  ...
  projects: [
    {
      title: "Mary Sibande",
      href: "https://www.marysibande.com/",
      active: true,
      description:
        "Website for award winning cotenmpory South African artist Mary Sibande",
      technologies: [
        "Wordpress",
        "Oxygen",
        "Motion.page",
    ...
    {
      title: "ish.pm",
      href: "https://app.ish.pm",
      active: true,
      description:
        "An open source Agile & Scrum based project management web application",
      technologies: [
        "React",
        "ShadCN",
        "PostgreSQL",
      ...
      links: [
        ...
        {
          type: "Source",
          href: "https://github.com/joshelvn11/ish-app",
          icon: <Icons.github className="size-3" />,
        },
      ],
      image: "/ish-app.png",
    ...
    },
    {
      ...
      active: true,
      description:
        "eCommerce store for Organic Zone, a premium organic grocery store located in Cape Town pushing the boundaries on service excellence in their industry.",
      technologies: [
        "Wordpress",
        "Oxygen",
        "WooCommerce",
